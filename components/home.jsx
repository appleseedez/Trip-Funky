      ...
      <div className='home-view'>
        ...
        <div className="gray-bg-box">
          <div className="photo-box layout-center-box">
            <img src="/images/static-1.jpg" />
          </div>
          <Recommand {...this.props.dataParams} />
          <div className="photo-box layout-center-box">
            <img src="/images/static-2.jpg" />
          </div>
        </div>
        ...
        <div className="photo-box photo-box-border layout-center-box">
          <img src="/images/static-3.jpg" />
        </div>
        <div className="photo-box layout-center-box">
          <img src="/images/static-4.jpg" />
        </div>
        <div className="photo-box layout-center-box">
          <img src="/images/static-6.jpg" />
        </div>
